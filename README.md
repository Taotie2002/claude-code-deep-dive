...
| [query-engine-deep-dive.md](./query-engine-deep-dive.md) | **QueryEngine核心剖析** - Claude Code引擎深度分析 |
| [agent-lifecycle.md](./agent-lifecycle.md) | **Agent生命周期** - Spawn/Execute/Review/Fix/Terminate |
| [behavior-analysis.md](./behavior-analysis.md) | 行为分析（7个行为流程图） |
